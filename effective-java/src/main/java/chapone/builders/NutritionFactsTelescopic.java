...
// harder to write when there are many parameters and also harder to read.
// if the client reverses the parameters, it can lead to bugs.
...
public class NutritionFactsTelescopic {
    ...
    public NutritionFactsTelescopic(int servingSize, int servings, int calories, int fat, int sodium, int carbohydrate) {
